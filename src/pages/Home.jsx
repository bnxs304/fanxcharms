    ...
    <div className="home">
      ...
      <section className="whats-new">
        <header className="whats-new__header">
          <p className="whats-new__eyebrow">Exclusive merch, collectables, and <span className="whats-new__eyebrow-highlight">charms </span>inspired by K-pop, anime, and gaming.</p>
          <h2 className="whats-new__title">What's new?</h2>
          <p className="whats-new__description">Fresh drops for every fandom.</p>
        </header>
        <div className="whats-new__content">
          ...
          <div className="whats-new__social">
            <div className="whats-new__social-header">
            <p className="whats-new__social-text">Follow us on social media, and see us in person at events for discounts and more exclusive merch.</p>
            </div>
            <div className="whats-new__social-icons">
